...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-100 selection:bg-orange-500/30 selection:text-orange-200 font-sans overflow-x-hidden relative flex flex-col">
