...
const RULES = [
  ...
  'Сертифікат використовується одноразово — повторне використання неможливе. Якщо сума покупки перевищує номінал сертифіката, різницю необхідно доплатити. Якщо сума покупки менша — залишок не зберігається і не повертається',
